...
const File = sequelize.define('File', {
  ...
  maxDownloads: { type: DataTypes.INTEGER, defaultValue: 1, field: 'max_downloads' },
  ...
  lastAccessedAt: { type: DataTypes.DATE, field: 'last_accessed_at' }
}, { tableName: 'files', timestamps: true, createdAt: 'created_at', updatedAt: false });
...
File.prototype.getRemainingDownloads = function() { return Math.max(0, this.maxDownloads - this.downloadCount); };
